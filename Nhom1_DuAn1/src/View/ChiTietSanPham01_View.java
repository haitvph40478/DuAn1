 ...
 * @author GIGABYTE
 */
public class ChiTietSanPham01_View extends javax.swing.JFrame {

    private SanPhamChiTiet_Service mot = new SanPhamChiTiet_Service();
    private DefaultTableModel model = new DefaultTableModel();
    /**
     * Creates new form ChiTietSanPham01_Service
     */
    public ChiTietSanPham01_View() {
        initComponents();
        this.fillTable_SanPhamChiTiet01(mot.getAll_CTSP1());
        this.setLocationRelativeTo(null);
    }

    void fillTable_SanPhamChiTiet01(List<SanPhamChiTiet> list) {
        model = (DefaultTableModel) tbCTSP1.getModel();
        ...
        int stt = tbCTSP1.getSelectedRow();
        stt = stt + 1;
    ...
    private void initComponents() {
        ...
        tbCTSP1 = new javax.swing.JTable();
        ...
        tbCTSP1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane2.setViewportView(tbCTSP1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChiTietSanPham01_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
